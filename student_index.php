...
<div class="wrapper">
	        				...
	        				<table class="table table-bordered table-striped" id="booklist">
			        			...
			        			<?php
			        				...
			        				while($row = $query->fetch_assoc()){
			        					...
			        					$button = ($row['status'] == 0) ? '<a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Borrow</a>' : '<span class="label label-danger">Issued</span>';
			        				    
										$book_photo = (!empty($row['book_photo'])) ? 'book_images/'.$row['book_photo'] : 'images/profile.jpg';
										echo "
			        						<tr>
												<td>
													<img src='".$book_photo."' width='80px' height='100px'>
	...
	<?php include 'student_borrow/includes/borrow_modal.php'; ?>
</div>
...
$(function(){
	$('#catlist').on('change', function(){
		if($(this).val() == 0){
			...
			window.location = 'student_index.php?category='+$(this).val();
		}
