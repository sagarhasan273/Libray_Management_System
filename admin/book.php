                ...
                <tbody>
                  <?php
                    ...
                    while($row = $query->fetch_assoc()){
                      ...
                      $photo = (!empty($row['book_photo'])) ? '../book_images/'.$row['book_photo'] : '../images/profile.jpg';
                      echo "
                        <tr>
                          <td>
                          ...
                          <td>".$status."</td>
                          <td>
                            <button class='btn btn-success btn-sm edit btn-flat' data-id='".$row['bookid']."'><i class='fa fa-edit'>Edit</i></button>
                            <button class='btn btn-danger btn-sm delete btn-flat' data-id='".$row['bookid']."'><i class='fa fa-trash'>Delete</i></button>
                          </td>
                        </tr>
                      ";
                    }
